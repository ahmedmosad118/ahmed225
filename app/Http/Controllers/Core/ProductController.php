...
class ProductController extends Controller
{
        ...
        public function create()
    {
        ...
        return view('Core.products.addproduct',compact('types',"editions",'brands','models'));
    }
    ...
    public function show()
    {
                ...
                return view('Core.products.showproducts',compact("products"));

    }
    public function show_product($id)
    {
       $products=Product::find($id);
       return view('Core.products.showproduct',compact("products"));
    ...
    public function edit($id)
    {
        ...
        $models=CarModel::all();
        $types=ProductType::all();
        return view('Core.products.editproduct',compact('types',"editions",'brands','models',"product"));
