...
class PatchController extends Controller
{
        public function create()
    {
        ...
        return view("Core.patches.addpatch",compact("products","suppliers"));
    ...
    {
        $patches=Patch::all();
        return view('Core.patches.showpatches',compact("patches"));
    ...
    public function edit($id)
    {
        ...
        $products=Product::all();
        $suppliers=Supplier::all();
        return view('Core.patches.editpatch',compact('suppliers',"products","patch"));
