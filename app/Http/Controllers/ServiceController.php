...
class ServiceController extends Controller
{
...

    {
                ...
                return view('products.addservice',compact('products','services'));
    ...
    {
            $services=ProductService::all();
            return view('products.showservices',compact("services"));
    ...
    public function edit($id)
    {
        ...
        return view('products.editservice',compact('service'));
